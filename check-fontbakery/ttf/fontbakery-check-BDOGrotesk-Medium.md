...
</div></details><br></div></details><details><summary><b>[95] BDOGrotesk-Medium.ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Ensure component transforms do not perform scaling or rotation. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/universal.html#com.google.fonts/check/transformed_components">com.google.fonts/check/transformed_components</a>)</summary><div>
...
>
* ⚠ **WARN** The most common width is 607 among a set of 2 math glyphs.
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* percent (U+0025): X=648.0,Y=730.0 (should be at cap-height 729?)

	* percent (U+0025): X=749.0,Y=730.0 (should be at cap-height 729?)

	* parenleft (U+0028): X=127.0,Y=1.5 (should be at baseline 0?)

	* parenright (U+0029): X=184.0,Y=2.0 (should be at baseline 0?)

	* a (U+0061): X=582.0,Y=2.0 (should be at baseline 0?)

	* f (U+0066): X=92.0,Y=565.0 (should be at x-height 566?)

	* f (U+0066): X=206.0,Y=565.0 (should be at x-height 566?)

	* r (U+0072): X=363.0,Y=567.0 (should be at x-height 566?)

	* t (U+0074): X=98.0,Y=565.0 (should be at x-height 566?)

	* t (U+0074): X=212.0,Y=731.0 (should be at cap-height 729?) 
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	...
	* dollar (U+0024) contains a short segment B<<355.0,425.0>-<361.0,423.0>-<368.0,422.0>>

	* less (U+003C) contains a short segment L<<180.0,349.0>--<180.0,340.0>>

	* greater (U+003E) contains a short segment L<<426.0,340.0>--<426.0,349.0>>

	* f (U+0066) contains a short segment L<<319.0,694.0>--<313.0,694.0>>

	* r (U+0072) contains a short segment L<<363.0,457.0>--<356.0,457.0>>

	* y (U+0079) contains a short segment L<<60.0,-71.0>--<68.0,-71.0>>

	* ordfeminine (U+00AA) contains a short segment B<<427.0,375.0>-<431.0,375.0>-<435.0,375.5>>

	* ordfeminine (U+00AA) contains a short segment B<<435.0,375.5>-<439.0,376.0>-<443.0,376.0>>

	* germandbls (U+00DF) contains a short segment B<<315.0,329.0>-<304.0,329.0>-<293.0,328.0>>

	* germandbls (U+00DF) contains a short segment L<<293.0,418.0>--<312.0,418.0>> 
...
* ⚠ **WARN** The following glyphs have colinear vectors:
	...
	* exclam (U+0021): L<<116.0,222.0>--<94.0,556.0>> -> L<<94.0,556.0>--<94.0,729.0>>

	* exclam (U+0021): L<<211.0,729.0>--<211.0,556.0>> -> L<<211.0,556.0>--<188.0,222.0>>

	* exclamdown (U+00A1): L<<116.0,344.0>--<94.0,10.0>> -> L<<94.0,10.0>--<94.0,-163.0>>

	* exclamdown (U+00A1): L<<211.0,-163.0>--<211.0,10.0>> -> L<<211.0,10.0>--<188.0,344.0>>

	* radical (U+221A): L<<304.0,401.0>--<304.0,401.0>> -> L<<304.0,401.0>--<305.0,401.0>>

	* uni21BA (U+21BA): L<<495.0,576.0>--<499.0,525.0>> -> L<<499.0,525.0>--<499.0,392.0>>

	* uni21BA (U+21BA): L<<752.0,636.0>--<610.0,636.0>> -> L<<610.0,636.0>--<565.0,639.0>>

	* uni21BB (U+21BB): L<<353.0,576.0>--<349.0,525.0>> -> L<<349.0,525.0>--<349.0,392.0>> 

	* uni21BB (U+21BB): L<<96.0,636.0>--<238.0,636.0>> -> L<<238.0,636.0>--<283.0,639.0>> [code: found-colinear-vectors]
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* M (U+004D): L<<729.0,0.0>--<734.0,626.0>>

	* arrowleft (U+2190): L<<239.0,292.0>--<848.0,293.0>>

	* arrowright (U+2192): L<<694.0,292.0>--<85.0,293.0>>

	* f (U+0066): L<<206.0,565.0>--<321.0,566.0>>

	* f (U+0066): L<<321.0,478.0>--<206.0,479.0>>

	* fi (U+FB01): L<<206.0,565.0>--<321.0,566.0>>

	* fi (U+FB01): L<<321.0,478.0>--<206.0,479.0>>

	* plus (U+002B): L<<246.0,391.0>--<247.0,608.0>>

	* plus (U+002B): L<<247.0,72.0>--<246.0,297.0>>

	* plus (U+002B): L<<353.0,297.0>--<354.0,72.0>> 
