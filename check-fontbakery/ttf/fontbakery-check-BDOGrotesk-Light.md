...
</div></details><br></div></details><details><summary><b>[95] BDOGrotesk-Light.ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Ensure component transforms do not perform scaling or rotation. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/universal.html#com.google.fonts/check/transformed_components">com.google.fonts/check/transformed_components</a>)</summary><div>
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* t (U+0074): X=170.0,Y=730.0 (should be at cap-height 729?)

	* Oslash (U+00D8): X=104.0,Y=1.0 (should be at baseline 0?)

	* Oslash (U+00D8): X=642.0,Y=730.0 (should be at cap-height 729?)

	* uni0163 (U+0163): X=170.0,Y=730.0 (should be at cap-height 729?)
	...
	* Oslashacute (U+01FE): X=642.0,Y=730.0 (should be at cap-height 729?) 
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	...
	* less (U+003C) contains a short segment L<<132.0,327.0>--<132.0,319.0>>

	* greater (U+003E) contains a short segment L<<469.0,319.0>--<469.0,327.0>>

	* f (U+0066) contains a short segment L<<238.0,734.0>--<234.0,734.0>>

	* r (U+0072) contains a short segment L<<311.0,496.0>--<306.0,496.0>>

	* y (U+0079) contains a short segment L<<43.0,-114.0>--<46.0,-114.0>>

	* ordfeminine (U+00AA) contains a short segment B<<398.0,357.0>-<403.0,357.0>-<407.0,357.5>>

	* ordfeminine (U+00AA) contains a short segment B<<407.0,357.5>-<411.0,358.0>-<415.0,358.0>>

	* germandbls (U+00DF) contains a short segment B<<291.0,355.0>-<280.0,355.0>-<270.0,354.0>>

	* germandbls (U+00DF) contains a short segment L<<270.0,413.0>--<292.0,413.0>>

	* ae (U+00E6) contains a short segment B<<904.0,290.0>-<903.0,274.0>-<902.0,266.0>> 
...
* ⚠ **WARN** The following glyphs have colinear vectors:
	...
	* exclam (U+0021): L<<115.0,205.0>--<102.0,536.0>> -> L<<102.0,536.0>--<102.0,729.0>>

	* exclam (U+0021): L<<165.0,729.0>--<165.0,536.0>> -> L<<165.0,536.0>--<152.0,205.0>>

	* exclamdown (U+00A1): L<<115.0,352.0>--<102.0,21.0>> -> L<<102.0,21.0>--<102.0,-172.0>>

	* exclamdown (U+00A1): L<<165.0,-172.0>--<165.0,21.0>> -> L<<165.0,21.0>--<152.0,352.0>>

	* radical (U+221A): L<<276.0,386.0>--<276.0,386.0>> -> L<<276.0,386.0>--<277.0,386.0>>

	* uni21BA (U+21BA): L<<471.0,625.0>--<476.0,555.0>> -> L<<476.0,555.0>--<476.0,411.0>>

	* uni21BA (U+21BA): L<<737.0,666.0>--<587.0,666.0>> -> L<<587.0,666.0>--<519.0,671.0>>

	* uni21BB (U+21BB): L<<106.0,666.0>--<256.0,666.0>> -> L<<256.0,666.0>--<324.0,671.0>> 

	* uni21BB (U+21BB): L<<372.0,625.0>--<367.0,555.0>> -> L<<367.0,555.0>--<367.0,411.0>> [code: found-colinear-vectors]
...
* ⚠ **WARN** The following glyphs have jaggy segments:
	...
	* braceleft (U+007B): B<<229.5,371.0>-<211.0,335.0>-<176.0,332.0>>/B<<176.0,332.0>-<211.0,329.0>-<229.5,293.0>> = 9.79818490757551

	* braceright (U+007D): B<<178.5,371.0>-<197.0,335.0>-<232.0,332.0>>/B<<232.0,332.0>-<197.0,329.0>-<178.5,293.0>> = 9.79818490757551

	* uni270F (U+270F): B<<779.5,221.5>-<770.0,175.0>-<747.0,134.0>>/B<<747.0,134.0>-<754.0,142.0>-<774.5,158.0>> = 11.89456299472543 

	* uni270F (U+270F): B<<834.0,441.0>-<763.0,488.0>-<747.0,506.0>>/B<<747.0,506.0>-<770.0,466.0>-<779.5,419.5>> = 11.734637497955664 [code: found-jaggy-segments]
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* M (U+004D): L<<149.0,676.0>--<151.0,0.0>>

	* M (U+004D): L<<742.0,0.0>--<743.0,677.0>>

	* P (U+0050): L<<414.0,317.0>--<151.0,318.0>>

	* summation (U+2211): L<<523.0,676.0>--<122.0,675.0>>

	* uni20BA (U+20BA): L<<587.0,329.0>--<586.0,149.0>>

	* uni2600 (U+2600): L<<68.0,382.0>--<213.0,383.0>>

	* uni2600 (U+2600): L<<798.0,347.0>--<653.0,346.0>> 

	* uni261E (U+261E): L<<921.0,426.0>--<522.0,427.0>> [code: found-semi-vertical]
