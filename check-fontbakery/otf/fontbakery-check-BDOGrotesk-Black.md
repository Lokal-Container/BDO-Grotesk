...
</div></details><br></div></details><details><summary><b>[95] BDOGrotesk-Black.otf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Ensure soft_dotted characters lose their dot when combined with marks that replace the dot. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/universal.html#com.google.fonts/check/soft_dotted">com.google.fonts/check/soft_dotted</a>)</summary><div>
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	...
	* less (U+003C) contains a short segment L<<240.0,331.0>--<240.0,341.0>>

	* greater (U+003E) contains a short segment L<<360.0,341.0>--<360.0,331.0>>

	* at (U+0040) contains a short segment L<<582.0,443.0>--<580.0,443.0>>

	* a (U+0061) contains a short segment L<<581.0,0.0>--<581.0,6.0>>

	* y (U+0079) contains a short segment L<<233.0,37.0>--<229.0,24.0>>

	* braceleft (U+007B) contains a short segment L<<30.0,255.0>--<41.0,255.0>>

	* braceright (U+007D) contains a short segment L<<400.0,387.0>--<389.0,387.0>>

	* registered (U+00AE) contains a short segment L<<714.0,149.0>--<714.0,159.0>>

	* agrave (U+00E0) contains a short segment L<<581.0,0.0>--<581.0,6.0>>

	* aacute (U+00E1) contains a short segment L<<581.0,0.0>--<581.0,6.0>> 
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* arrowright (U+2192): L<<60.0,291.0>--<556.0,290.0>>

	* arrowup (U+2191): L<<402.0,0.0>--<403.0,496.0>>

	* franc (U+20A3): L<<583.0,728.0>--<121.0,729.0>>

	* uni03BC (U+03BC): L<<63.0,584.0>--<61.0,-167.0>>

	* uni21B9 (U+21B9): L<<80.0,139.0>--<663.0,138.0>>

	* uni21B9 (U+21B9): L<<967.0,590.0>--<384.0,591.0>>

	* uni2600 (U+2600): L<<48.0,331.0>--<174.0,332.0>>

	* uni2600 (U+2600): L<<778.0,398.0>--<652.0,397.0>> 

	* uni261E (U+261E): L<<499.0,427.0>--<898.0,426.0>> [code: found-semi-vertical]
