...
>
* 🍞 **PASS** OK
</div></details><br></div></details><details><summary><b>[95] BDOGrotesk-Regular.otf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Ensure soft_dotted characters lose their dot when combined with marks that replace the dot. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/universal.html#com.google.fonts/check/soft_dotted">com.google.fonts/check/soft_dotted</a>)</summary><div>
...
>
* ⚠ **WARN** The most common width is 608 among a set of 2 math glyphs.
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* aring (U+00E5): X=190.0,Y=730.0 (should be at cap-height 729?)

	* aring (U+00E5): X=391.0,Y=730.0 (should be at cap-height 729?)

	* aring (U+00E5): X=330.0,Y=730.0 (should be at cap-height 729?)

	* aring (U+00E5): X=250.0,Y=730.0 (should be at cap-height 729?) 
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	...
	* less (U+003C) contains a short segment L<<169.0,342.0>--<169.0,350.0>>

	* greater (U+003E) contains a short segment L<<439.0,350.0>--<439.0,342.0>>

	* at (U+0040) contains a short segment L<<619.0,430.0>--<616.0,430.0>>

	* a (U+0061) contains a short segment L<<574.0,73.0>--<568.0,73.0>>

	* agrave (U+00E0) contains a short segment L<<574.0,73.0>--<568.0,73.0>>

	* aacute (U+00E1) contains a short segment L<<574.0,73.0>--<568.0,73.0>>

	* acircumflex (U+00E2) contains a short segment L<<574.0,73.0>--<568.0,73.0>>

	* atilde (U+00E3) contains a short segment L<<574.0,73.0>--<568.0,73.0>>

	* adieresis (U+00E4) contains a short segment L<<574.0,73.0>--<568.0,73.0>>

	* aring (U+00E5) contains a short segment L<<574.0,73.0>--<568.0,73.0>> 
...
* ⚠ **WARN** The following glyphs have colinear vectors:
	...
	* exclam (U+0021): L<<180.0,218.0>--<200.0,551.0>> -> L<<200.0,551.0>--<200.0,729.0>>

	* exclam (U+0021): L<<97.0,729.0>--<97.0,551.0>> -> L<<97.0,551.0>--<117.0,218.0>>

	* exclamdown (U+00A1): L<<117.0,345.0>--<97.0,12.0>> -> L<<97.0,12.0>--<97.0,-166.0>>

	* exclamdown (U+00A1): L<<200.0,-166.0>--<200.0,12.0>> -> L<<200.0,12.0>--<180.0,345.0>>

	* uni21BA (U+21BA): L<<497.0,396.0>--<497.0,527.0>> -> L<<497.0,527.0>--<493.0,588.0>>

	* uni21BA (U+21BA): L<<556.0,647.0>--<613.0,643.0>> -> L<<613.0,643.0>--<752.0,643.0>>

	* uni21BB (U+21BB): L<<101.0,643.0>--<240.0,643.0>> -> L<<240.0,643.0>--<297.0,647.0>> 

	* uni21BB (U+21BB): L<<360.0,588.0>--<356.0,527.0>> -> L<<356.0,527.0>--<356.0,396.0>> [code: found-colinear-vectors]
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* arrowleft (U+2190): L<<229.0,292.0>--<859.0,293.0>>

	* arrowright (U+2192): L<<90.0,293.0>--<720.0,292.0>>

	* plus (U+002B): L<<252.0,304.0>--<253.0,74.0>>

	* plus (U+002B): L<<253.0,608.0>--<252.0,388.0>>

	* plus (U+002B): L<<347.0,388.0>--<348.0,608.0>>

	* plus (U+002B): L<<348.0,74.0>--<347.0,304.0>>

	* summation (U+2211): L<<170.0,639.0>--<535.0,640.0>>

	* uni03BC (U+03BC): L<<72.0,565.0>--<71.0,-167.0>>

	* uni21B9 (U+21B9): L<<150.0,157.0>--<780.0,156.0>>

	* uni21B9 (U+21B9): L<<996.0,572.0>--<366.0,573.0>> 

	* uni2600 (U+2600): L<<655.0,337.0>--<798.0,336.0>> [code: found-semi-vertical]
