...
>
* 🍞 **PASS** OK
</div></details><br></div></details><details><summary><b>[97] BDOGrotesk-Bold.otf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Ensure soft_dotted characters lose their dot when combined with marks that replace the dot. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/universal.html#com.google.fonts/check/soft_dotted">com.google.fonts/check/soft_dotted</a>)</summary><div>
...
>
* ⚠ **WARN** The most common width is 603 among a set of 3 math glyphs.
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* sterling (U+00A3): X=365.0,Y=730.0 (should be at cap-height 729?)

	* onequarter (U+00BC): X=62.0,Y=-1.0 (should be at baseline 0?)

	* onequarter (U+00BC): X=163.0,Y=-1.0 (should be at baseline 0?)

	* onehalf (U+00BD): X=62.0,Y=-1.0 (should be at baseline 0?)

	* onehalf (U+00BD): X=163.0,Y=-1.0 (should be at baseline 0?)

	* threequarters (U+00BE): X=208.0,Y=-1.0 (should be at baseline 0?)

	* threequarters (U+00BE): X=309.0,Y=-1.0 (should be at baseline 0?)

	* Oslash (U+00D8): X=52.0,Y=-1.0 (should be at baseline 0?)

	* Oslash (U+00D8): X=713.0,Y=728.0 (should be at cap-height 729?)

	* gbreve (U+011F): X=321.0,Y=731.0 (should be at cap-height 729?) 
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	...
	* less (U+003C) contains a short segment L<<212.0,335.0>--<212.0,345.0>>

	* greater (U+003E) contains a short segment L<<392.0,345.0>--<392.0,335.0>>

	* at (U+0040) contains a short segment L<<597.0,438.0>--<594.0,438.0>>

	* a (U+0061) contains a short segment L<<605.0,114.0>--<599.0,114.0>>

	* agrave (U+00E0) contains a short segment L<<605.0,114.0>--<599.0,114.0>>

	* aacute (U+00E1) contains a short segment L<<605.0,114.0>--<599.0,114.0>>

	* acircumflex (U+00E2) contains a short segment L<<605.0,114.0>--<599.0,114.0>>

	* atilde (U+00E3) contains a short segment L<<605.0,114.0>--<599.0,114.0>>

	* adieresis (U+00E4) contains a short segment L<<605.0,114.0>--<599.0,114.0>>

	* aring (U+00E5) contains a short segment L<<605.0,114.0>--<599.0,114.0>> 
...
* ⚠ **WARN** The following glyphs have colinear vectors:
	...
	* exclam (U+0021): L<<212.0,235.0>--<241.0,571.0>> -> L<<241.0,571.0>--<241.0,729.0>>

	* exclam (U+0021): L<<84.0,729.0>--<84.0,571.0>> -> L<<84.0,571.0>--<113.0,235.0>>
	...
	* uni21BA (U+21BA): L<<503.0,381.0>--<503.0,519.0>> -> L<<503.0,519.0>--<501.0,544.0>> 
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* M (U+004D): L<<725.0,576.0>--<722.0,0.0>>

	* arrowdown (U+2193): L<<395.0,192.0>--<394.0,729.0>>

	* arrowleft (U+2190): L<<266.0,291.0>--<816.0,292.0>>

	* arrowright (U+2192): L<<72.0,292.0>--<622.0,291.0>>

	* arrowup (U+2191): L<<394.0,0.0>--<395.0,537.0>>

	* franc (U+20A3): L<<558.0,728.0>--<108.0,729.0>>

	* uni00B5 (U+00B5): L<<67.0,576.0>--<65.0,-167.0>>

	* uni03BC (U+03BC): L<<67.0,576.0>--<65.0,-167.0>>

	* uni21A4 (U+21A4): L<<266.0,291.0>--<726.0,292.0>>

	* uni21A5 (U+21A5): L<<394.0,134.0>--<395.0,537.0>> 
