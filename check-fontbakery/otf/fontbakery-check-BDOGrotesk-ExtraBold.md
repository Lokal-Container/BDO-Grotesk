...
</div></details><br></div></details><details><summary><b>[95] BDOGrotesk-ExtraBold.otf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Ensure soft_dotted characters lose their dot when combined with marks that replace the dot. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/universal.html#com.google.fonts/check/soft_dotted">com.google.fonts/check/soft_dotted</a>)</summary><div>
...
* ⚠ **WARN** The following glyphs have on-curve points which have potentially incorrect y coordinates:
	...
	* underscore (U+005F): X=446.0,Y=-1.0 (should be at baseline 0?)

	* underscore (U+005F): X=42.0,Y=-1.0 (should be at baseline 0?)

	* grave (U+0060): X=120.0,Y=730.0 (should be at cap-height 729?)

	* grave (U+0060): X=251.0,Y=730.0 (should be at cap-height 729?)

	* r (U+0072): X=409.0,Y=581.0 (should be at x-height 580?)

	* t (U+0074): X=96.0,Y=727.0 (should be at cap-height 729?)

	* exclamdown (U+00A1): X=80.0,Y=2.0 (should be at baseline 0?)

	* exclamdown (U+00A1): X=254.0,Y=2.0 (should be at baseline 0?)

	* sterling (U+00A3): X=378.0,Y=730.0 (should be at cap-height 729?)

	* dieresis (U+00A8): X=51.0,Y=730.0 (should be at cap-height 729?) 
...
* ⚠ **WARN** The following glyphs have segments which seem very short:
	...
	* less (U+003C) contains a short segment L<<226.0,333.0>--<226.0,343.0>>

	* greater (U+003E) contains a short segment L<<376.0,343.0>--<376.0,333.0>>

	* at (U+0040) contains a short segment L<<589.0,440.0>--<587.0,440.0>>

	* a (U+0061) contains a short segment L<<570.0,0.0>--<570.0,6.0>>

	* braceleft (U+007B) contains a short segment L<<44.0,262.0>--<58.0,262.0>>

	* braceright (U+007D) contains a short segment L<<388.0,383.0>--<374.0,383.0>>

	* registered (U+00AE) contains a short segment L<<708.0,149.0>--<708.0,160.0>>

	* agrave (U+00E0) contains a short segment L<<570.0,0.0>--<570.0,6.0>>

	* aacute (U+00E1) contains a short segment L<<570.0,0.0>--<570.0,6.0>>

	* acircumflex (U+00E2) contains a short segment L<<570.0,0.0>--<570.0,6.0>> 
...
* ⚠ **WARN** The following glyphs have colinear vectors:
	...
	* exclam (U+0021): L<<222.0,240.0>--<254.0,577.0>> -> L<<254.0,577.0>--<254.0,729.0>>

	* exclam (U+0021): L<<80.0,729.0>--<80.0,577.0>> -> L<<80.0,577.0>--<112.0,240.0>>

	* exclamdown (U+00A1): L<<112.0,339.0>--<80.0,2.0>> -> L<<80.0,2.0>--<80.0,-149.0>>

	* exclamdown (U+00A1): L<<254.0,-149.0>--<254.0,2.0>> -> L<<254.0,2.0>--<222.0,339.0>>

	* uni21BA (U+21BA): L<<505.0,376.0>--<505.0,517.0>> -> L<<505.0,517.0>--<504.0,528.0>> 

	* uni21BB (U+21BB): L<<323.0,528.0>--<322.0,517.0>> -> L<<322.0,517.0>--<322.0,376.0>> [code: found-colinear-vectors]
...
* ⚠ **WARN** The following glyphs have semi-vertical/semi-horizontal lines:
	...
	* M (U+004D): L<<720.0,553.0>--<719.0,0.0>>

	* arrowdown (U+2193): L<<399.0,212.0>--<398.0,729.0>>

	* arrowleft (U+2190): L<<279.0,290.0>--<801.0,291.0>>

	* arrowright (U+2192): L<<66.0,291.0>--<589.0,290.0>>

	* arrowup (U+2191): L<<398.0,0.0>--<399.0,517.0>>

	* franc (U+20A3): L<<570.0,728.0>--<114.0,729.0>>

	* plus (U+002B): L<<222.0,270.0>--<223.0,63.0>>

	* plus (U+002B): L<<223.0,608.0>--<222.0,403.0>>

	* plus (U+002B): L<<377.0,403.0>--<378.0,608.0>>

	* plus (U+002B): L<<378.0,63.0>--<377.0,270.0>> 
